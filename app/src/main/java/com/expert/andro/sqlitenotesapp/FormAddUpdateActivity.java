package com.expert.andro.sqlitenotesapp;
...
import com.expert.andro.sqlitenotesapp.db.NoteHelper;
...
public class FormAddUpdateActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void showAlertDialog(int type) {
        ...
        if (isDialogClose){
            ...
            dialogTitle = "Apakah anda yakin ingin menghapus item ini?";
            dialogMessage = "Hapus note";
        }
